...
version_info = json.load(BASE_DIR.joinpath('mailkit', 'version.json').open())
...
setup(
    ...
    project_urls={
        'Documentation': 'https://mailkit.readthedocs.io',
        'Tracker': 'https://github.com/suqingdong/mailkit/issues',
    },
    license='MIT License',
